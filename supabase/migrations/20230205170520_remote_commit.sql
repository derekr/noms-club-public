...
--
-- Name: event_category_noms; Type: TABLE; Schema: public; Owner: supabase_admin
--

CREATE TABLE "public"."event_category_noms" (
    "id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."event_category_noms" OWNER TO "supabase_admin";
...
--
-- Name: pools; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE "public"."pools" OWNER TO "supabase_admin";
...
--
-- Name: event_category_noms event_category_noms_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."event_category_noms"
    ADD CONSTRAINT "event_category_noms_pkey" PRIMARY KEY ("id");
...
--
-- Name: pools pool_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: pools handle_updated_at; Type: TRIGGER; Schema: public; Owner: supabase_admin
--

CREATE TRIGGER "handle_updated_at" BEFORE UPDATE ON "public"."pools" FOR EACH ROW EXECUTE FUNCTION "extensions"."moddatetime"('updated_at');
...
--
-- Name: event_categories event_categories_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: event_category_noms event_category_noms_event_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."event_category_noms"
    ADD CONSTRAINT "event_category_noms_event_category_id_fkey" FOREIGN KEY ("event_category_id") REFERENCES "public"."event_categories"("id");


--
-- Name: event_category_noms event_category_noms_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."event_category_noms"
    ADD CONSTRAINT "event_category_noms_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id");


--
-- Name: pools pools_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."pools"
    ADD CONSTRAINT "pools_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "auth"."users"("id");
...
--
-- Name: pools Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: event_category_noms; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--

ALTER TABLE "public"."event_category_noms" ENABLE ROW LEVEL SECURITY;
...
--
-- Name: pools; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--
...
GRANT ALL ON TABLE "public"."event_categories" TO "postgres";
...
--
-- Name: TABLE "event_category_noms"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE "public"."event_category_noms" TO "postgres";
GRANT ALL ON TABLE "public"."event_category_noms" TO "anon";
GRANT ALL ON TABLE "public"."event_category_noms" TO "authenticated";
GRANT ALL ON TABLE "public"."event_category_noms" TO "service_role";
...
--
-- Name: TABLE "pools"; Type: ACL; Schema: public; Owner: supabase_admin
--
